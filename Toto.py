...
if user_input == "Game1":
    ...
    while attempts1 < 5:
        ...
        attempts1 += 1
        if attempts1 == 5:
            print("Game Over!The five numbers were " + str(number1) + "," + str(number2) + "," + str(number3) + "," + str(number4) + "," + str(number5) + ".")
...
print("Game Over!The six numbers were " + str(number11) + "," + str(number22) + "," + str(number33) + "," + str(number44) + "," + str(number55) + "," + str(number66) + ".")
